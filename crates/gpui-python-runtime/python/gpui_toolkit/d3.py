...
LinePoint = _native.LinePoint
LineConfig = _native.LineConfig
LineSceneGeometry = _native.LineSceneGeometry
CurveType = _native.CurveKind
StrokeDashArray = _native.StrokeDashArray
CustomDashArray = _native.CustomDashArray
LineRenderErrorKind = _native.LineRenderErrorKind
LineRenderError = _native.LineRenderError
Curve = _native.Curve
...
AreaGenerationErrorKind = _native.AreaGenerationErrorKind
Area = _native.Area
