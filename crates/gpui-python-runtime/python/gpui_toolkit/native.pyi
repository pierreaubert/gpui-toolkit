...
class Voronoi:
    ...
    def render_to_path_into(self) -> str: ...
    def render_bounds_to_path(self) -> str: ...
    def render_bounds_to_path_into(self) -> str: ...
    def render_cell_to_path(self, index: int) -> str | None: ...
    def render_cell_to_path_into(self, index: int) -> str | None: ...
...
StackLayoutError: type[ValueError]
...
RadialGenerationError: type[ValueError]
class RadialPoint:
    angle: float
    radius: float
...
ChordLayoutError: type[ValueError]
...
class LegendItem:
    ...
    @classmethod
    def with_symbol(
        cls, label: str, color: str, symbol: LegendSymbol | str
    ) -> LegendItem: ...
