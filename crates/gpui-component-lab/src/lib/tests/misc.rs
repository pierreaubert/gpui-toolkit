...
fn component_lab_conformance_reports_bad_story_metadata() {
    ...
    registry
        .register(
            ComponentStory::new("test.metadata", "test", "Metadata", "Metadata story").metadata([
...
fn component_lab_conformance_reports_rendered_bounds_order_failure() {
    let mut registry = StoryRegistry::new();
    let story = ComponentStory::new("test.bounds", "test", "Bounds", "Bounds story").conformance(
        StoryConformance {
            rendered: RenderedPreviewConformance::new(200.0, 120.0).observed_bounds(160.0, 120.0),
...
fn component_lab_conformance_reports_touch_rendered_area_failure() {
    let mut registry = StoryRegistry::new();
    let story = ComponentStory::new("test.touch-area", "test", "Touch", "Touch story").conformance(
