...
impl Showcase {
    pub(crate) fn render_qr_section(&self, cx: &mut Context<Self>) -> impl IntoElement {
                ...
                HStack::new()
                    ...
                    .child(
                        VStack::new()
                            ...
                            .child(self.animated_qr_tiny.as_ref().map_or_else(
                                || {
                                    Text::new("QR preview unavailable.")
                                        .muted(true)
                                        .into_any_element()
                                },
                    ...
                    .child(
                        VStack::new()
                            ...
                            .child(self.animated_qr_small.as_ref().map_or_else(
                                || {
                                    Text::new("QR preview unavailable.")
                                        .muted(true)
                                        .into_any_element()
