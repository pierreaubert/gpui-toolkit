...
use super::misc::{TextSizeCache, TextSizeInput, compute_text_size};
...
mod tests {
    ...
    fn text_size_cache_shares_measurements_for_duplicate_text() {
        ...
        let measure = CountingMeasure { char_width: 10.0 };
        ...
        let calls_for_two_duplicates = CALLS.load(Ordering::SeqCst);
        ...
        let calls_for_single = CALLS.load(Ordering::SeqCst);
